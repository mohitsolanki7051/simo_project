...
class CashMemoInvoiceSettingController extends Controller
{
    /**
    ...
    {
        $setting = CashMemoInvoiceSetting::first();
        return view('admin.sales.cashmemo-invoice-setting', compact('setting'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!$setting) {
                $setting = new CashMemoInvoiceSetting();
                \Log::info('Creating new CashMemoInvoiceSetting record');
            } else {
                \Log::info('Updating existing CashMemoInvoiceSetting record ID: ' . $setting->_id);
            }
