        ...
        <div class="tab-container">
            ...
            <div class="tab-content-wrapper">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="body_type" required>
                                ...
                                <option value="PVC" {{ old('body_type') == 'PVC' ? 'selected' : '' }}>PVC</option>
                                <option value="Metal" {{ old('body_type') == 'Metal' ? 'selected' : '' }}>Metal</option>
                            </select>
                        </div>
                ...
                <div class="tab-content" id="variants">
                    <div class="tab-header">
                        <h3 class="tab-title">Variants & Stock</h3>
                        <p class="tab-description">Manage variations and inventory</p>
                    </div>
                    ...
                    <div class="variants-container">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" name="sku_code" value="{{ old('sku_code') }}" placeholder="LED-9W-001">
                            </div>

                            <div class="form-group">
                                <label class="form-label">Watt</label>
                                <input type="text" class="form-input" name="watt" value="{{ old('watt') }}" placeholder="9W">
                            </div>

                            <div class="form-group">
                                <label class="form-label">Shape</label>
                                <input type="text" class="form-input" name="shape" value="{{ old('shape') }}" placeholder="Round">
                            </div>

                            <div class="form-group">
                                <label class="form-label">Color Temperature</label>
                                <select class="form-select" name="color_temperature">
                                    <option value="">Select</option>
                                    <option value="WW" {{ old('color_temperature') == 'WW' ? 'selected' : '' }}>WW (Warm White)</option>
                                    <option value="NW" {{ old('color_temperature') == 'NW' ? 'selected' : '' }}>NW (Natural White)</option>
                                    <option value="WH" {{ old('color_temperature') == 'WH' ? 'selected' : '' }}>WH (White)</option>
                                    <option value="3IN1" {{ old('color_temperature') == '3IN1' ? 'selected' : '' }}>3IN1</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label class="form-label">Cutting/Size</label>
                                <input type="text" class="form-input" name="cutting_size" value="{{ old('cutting_size') }}" placeholder="75mm">
                            </div>

                            <div class="form-group">
                                <label class="form-label">Unit</label>
                                <input type="text" class="form-input" name="unit" value="{{ old('unit') }}" placeholder="Piece, Box, Set">
                            </div>
                        </div>

                        <div class="form-section-title">Pricing Variants</div>
                        <div class="form-grid">
                            <div class="form-group">
                                <label class="form-label">Cost Price (₹)</label>
                                <input type="number" step="0.01" class="form-input" name="cost_price" value="{{ old('cost_price') }}" placeholder="0.00">
                                <span class="form-hint">Your purchase price</span>
                            </div>

                            <div class="form-group">
                                <label class="form-label">Dealer Price (₹)</label>
                                <input type="number" step="0.01" class="form-input" name="dealer_price" value="{{ old('dealer_price') }}" placeholder="0.00">
                            </div>

                            <div class="form-group">
                                <label class="form-label">Distributor Price (₹)</label>
                                <input type="number" step="0.01" class="form-input" name="distributor_price" value="{{ old('distributor_price') }}" placeholder="0.00">
                            </div>
                        </div>

                        <div class="form-section-title">Stock Management</div>
                        <div class="form-grid">
                            <div class="form-group">
...
<style>
    ...
    .form-section-title { font-size: 16px; font-weight: 700; color: #2d3748; margin: 25px 0 20px; padding-bottom: 10px; border-bottom: 2px solid #e2e8f0; }
    .variants-container { background: #f7fafc; padding: 25px; border-radius: 12px; border: 2px dashed #cbd5e0; }
...
<script>
    let currentTab = 0;
    const tabs = ['basic-info', 'pricing', 'variants', 'media'];
