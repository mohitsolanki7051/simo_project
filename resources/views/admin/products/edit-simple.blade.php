                ...
                <div class="tab-content active" id="basic-info">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea class="form-textarea" name="description" rows="4" placeholder="Enter product description with features and specifications" required>{{ old('description', $simpleProduct->description) }}</textarea>
                            @error('description')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="tab-content" id="pricing">
                    ...
                    <div class="form-grid three-columns">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-input" id="dealer_price" name="dealer_price" value="{{ old('dealer_price', $simpleProduct->dealer_price) }}" placeholder="0.00" min="0" required>
                            @error('dealer_price')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-input" id="distributor_price" name="distributor_price" value="{{ old('distributor_price', $simpleProduct->distributor_price) }}" placeholder="0.00" min="0" required>
