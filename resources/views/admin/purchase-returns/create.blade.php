{{-- resources/views/admin/purchase-returns/create.blade.php --}}
@extends('layouts.admin')

@section('title', 'Create Purchase Return - Admin Panel')
@section('header-title', 'Create Purchase Return')
...
<div class="pr-create-container">
    ...
    <div class="page-header">
        <div class="header-left">
            <h2 class="page-title">Create Purchase Return</h2>
        </div>
        <div class="header-right">
            <a href="{{ route('admin.purchase-returns.index') }}" class="btn-small btn-secondary">
                ← Back to Returns
            </a>
        </div>
    </div>
                ...
                <div class="section-header">
                    <div class="section-header-left">
                        ...
                        <div class="section-title">
                            ...
                            <p>Search and select the purchase invoice to return</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="selectedInvoiceDetails" class="selected-invoice-details" style="display: none;">
                        <div class="invoice-header">
                            ...
                            <div class="vendor-info">
                                <span class="vendor-name" id="vendorNameDisplay">Vendor Name</span>
                                <span class="vendor-phone" id="vendorPhoneDisplay">-</span>
                            </div>
...
.vendor-info { margin-top: 1px; }
.vendor-name { font-size: 10px; color: #374151; font-weight: 500; }
.vendor-phone { font-size: 9px; color: #9ca3af; margin-left: 7px; }
...
.invoice-header .vendor-info { text-align: center; }
.invoice-header .vendor-name  { display: block; font-size: 11px; font-weight: 500; color: #374151; }
.invoice-header .vendor-phone { font-size: 9px; color: #9ca3af; }
...
function searchInvoices(search) {
    $.get('{{ route('admin.purchase-returns.search-invoices') }}', {
        search: search
    }, function(response) {
            ...
            html += `
                <div class="invoice-item" onclick="selectInvoice('${invoice.id}')">
                    <div class="invoice-main">
                        ...
                        <div class="vendor-info">
                            <span class="vendor-name">${invoice.party_name}</span>
                        </div>
                    </div>
...
$('#purchaseReturnForm').submit(function(e) {
    ...
    $.ajax({
        url: '{{ route('admin.purchase-returns.store') }}',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
