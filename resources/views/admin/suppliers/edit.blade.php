...
<div class="edit-supplier-container">
    ...
    <div class="page-header">
        <div class="header-left">
            ...
            <p class="page-description">ID: {{ $supplier->id }} | Created: {{ $supplier->created_at->format('d M Y') }}</p>
        </div>
        <div class="header-right">
            <a href="{{ route('admin.suppliers.show', $supplier->id) }}" class="btn-secondary">
        ...
        <form action="{{ route('admin.suppliers.update', $supplier->id) }}" method="POST" id="supplierForm">
                ...
                <div class="card-body">
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" name="name" value="{{ old('name', $supplier->name) }}" required placeholder="Enter supplier name">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Email Address</label>
                            <input type="email" class="form-input" name="email" value="{{ old('email', $supplier->email) }}" placeholder="supplier@example.com">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Phone Number <span class="required">*</span></label>
                            <input type="text" class="form-input" name="phone" value="{{ old('phone', $supplier->phone) }}" required placeholder="+91 9876543210">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Alternate Phone</label>
                            <input type="text" class="form-input" name="alternate_phone" value="{{ old('alternate_phone', $supplier->alternate_phone) }}" placeholder="Alternate phone number">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Contact Person</label>
                            <input type="text" class="form-input" name="contact_person" value="{{ old('contact_person', $supplier->contact_person) }}" placeholder="Name of contact person">
                        </div>
            ...
            <div class="form-card">
                <div class="card-header">
                    ...
                    <p class="card-description">Update the supplier's address details</p>
                </div>
                <div class="card-body">
                    <div class="form-grid">
                        <div class="form-group full-width">
                            <label class="form-label">Complete Address</label>
                            <textarea class="form-textarea" name="address" rows="3" placeholder="Enter complete address">{{ old('address', $supplier->address) }}</textarea>
                        </div>

                        <div class="form-group">
                            <label class="form-label">City</label>
                            <input type="text" class="form-input" name="city" value="{{ old('city', $supplier->city) }}" placeholder="City">
                        </div>

                        <div class="form-group">
                            <label class="form-label">State</label>
                            <input type="text" class="form-input" name="state" value="{{ old('state', $supplier->state) }}" placeholder="State">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Pincode</label>
                            <input type="text" class="form-input" name="pincode" value="{{ old('pincode', $supplier->pincode) }}" placeholder="Pincode">
                        </div>
            ...
            <div class="form-card">
                <div class="card-header">
                    ...
                    <p class="card-description">Update GSTIN, PAN and other legal details</p>
                </div>
                <div class="card-body">
                    <div class="form-grid">
                        <div class="form-group">
                            <label class="form-label">GSTIN</label>
                            <input type="text" class="form-input" name="gstin" value="{{ old('gstin', $supplier->gstin) }}" placeholder="22AAAAA0000A1Z5">
                            <span class="form-hint">Format: 22AAAAA0000A1Z5</span>
                        </div>

                        <div class="form-group">
                            <label class="form-label">PAN Number</label>
                            <input type="text" class="form-input" name="pan" value="{{ old('pan', $supplier->pan) }}" placeholder="AAAAA1234A">
            ...
            <div class="form-card">
                <div class="card-header">
                    ...
                    <p class="card-description">Update bank details and payment terms</p>
                </div>
                <div class="card-body">
                    <div class="form-grid">
                        <div class="form-group">
                            <label class="form-label">Bank Name</label>
                            <input type="text" class="form-input" name="bank_name" value="{{ old('bank_name', $supplier->bank_name) }}" placeholder="Bank name">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Account Number</label>
                            <input type="text" class="form-input" name="account_number" value="{{ old('account_number', $supplier->account_number) }}" placeholder="Account number">
                        </div>

                        <div class="form-group">
                            <label class="form-label">IFSC Code</label>
                            <input type="text" class="form-input" name="ifsc_code" value="{{ old('ifsc_code', $supplier->ifsc_code) }}" placeholder="IFSC code">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-input" name="credit_limit" value="{{ old('credit_limit', $supplier->credit_limit) }}" placeholder="0.00">
            ...
            <div class="form-card">
                ...
                <div class="card-body">
                    <div class="form-group full-width">
                        ...
                        <textarea class="form-textarea" name="notes" rows="4" placeholder="Enter any additional notes or information">{{ old('notes', $supplier->notes) }}</textarea>
...
<style>
    ...
    .btn-secondary { padding: 10px 16px; background: #edf2f7; color: #4a5568; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; transition: all 0.3s; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; }
