...
@section('title', 'Create Warehouse - Admin Panel')
@section('header-title', 'Create New Warehouse')
...
<div class="create-warehouse-container">
    ...
    <div class="page-header">
        <div class="header-left">
            ...
            <h2 class="page-title">Add New Warehouse</h2>
            <p class="page-subtitle">Create a new warehouse location</p>
        </div>
    </div>
        ...
        <div class="form-card">
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <p class="section-description">Enter warehouse identification details</p>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="code" value="{{ old('code') }}"
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <p class="section-description">Enter complete warehouse address</p>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="state" value="{{ old('state') }}"
                            placeholder="e.g., Delhi" required>
                        @error('state')
                            <span class="error-text">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="pincode" value="{{ old('pincode') }}"
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <p class="section-description">Warehouse contact details</p>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="manager_name" value="{{ old('manager_name') }}"
...
@push('styles')
<style>
    .create-warehouse-container { padding-bottom: 40px; }
    ...
    .btn-cancel { padding: 12px 24px; background: #e2e8f0; color: #4a5568; text-decoration: none; border-radius: 10px; font-weight: 600; transition: all 0.3s; display: flex; align-items: center; gap: 8px; }
